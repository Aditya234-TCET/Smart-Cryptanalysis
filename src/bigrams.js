...
export const COMMON_WORDS = new Set([
  ...
  "CRYPTOGRAPHY", "PRACTICE", "TECHNIQUES", "SECURE", "COMMUNICATION", "PRESENCE", 
  "ADVERSARIAL", "BEHAVIOR", "GENERALLY", "CONSTRUCTING", "ANALYZING", "PROTOCOLS", 
  "PREVENT", "THIRD", "PARTIES", "PUBLIC", "PRIVATE", "MESSAGES", "CIPHER", "ENCRYPT", 
  "DECRYPT", "PLAINTEXT", "CIPHERTEXT", "ALGORITHM", "VIGENERE", "CAESAR", "RAILFENCE", 
  "PLAYFAIR", "SUBSTITUTION", "TRANSPOSITION", "KEY", "CRYPTANALYSIS", "MACHINE", 
  "LEARNING", "PREDICTION", "ACCURACY", "FEATURE", "EXTRACTION", "STUDY"
]);
